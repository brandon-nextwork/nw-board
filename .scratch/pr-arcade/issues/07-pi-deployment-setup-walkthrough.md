...
**On-device run notes (2026-08-14):** deployed at /home/nextwork/pr-arcade/nw-board as user `nextwork`, funnel https://pr-arcade.tail176c54.ts.net. Root-caused a silent live-miss to the hook never being registered (repo's only hook was a GitHub→Discord webhook whose 204s looked like success). Remaining: cold-boot-to-kiosk + crash-restart verification.
